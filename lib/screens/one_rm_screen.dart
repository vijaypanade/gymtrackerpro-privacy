...
class _OneRmScreenState extends State<OneRmScreen> {
  ...
  static const _zones = [
    {'pct': 100, 'label': '1RM — Max Strength', 'reps': '1',   'color': 0xFFD4AF37},
    {'pct': 95,  'label': '95% — Near Max',      'reps': '2',   'color': 0xFFD4AF37},
    {'pct': 90,  'label': '90% — Strength',       'reps': '3',   'color': 0xFFD4AF37},
    {'pct': 85,  'label': '85% — Strength/Growth',   'reps': '5',   'color': 0xFFD4AF37},
    {'pct': 80,  'label': '80% — Muscle Growth',    'reps': '8',   'color': 0xFFB8962E},
    {'pct': 75,  'label': '75% — Muscle Growth',    'reps': '10',  'color': 0xFFB8962E},
    {'pct': 70,  'label': '70% — Endurance',      'reps': '12',  'color': 0xFF8C8C8C},
    {'pct': 65,  'label': '65% — Endurance',      'reps': '15',  'color': 0xFF8C8C8C},
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('1RM Calculator', style: TextStyle(fontFamily: 'Rajdhani',fontWeight: FontWeight.w700)),
        backgroundColor: AppColors.bg,
      ),
      body: ListView(
        ...
        children: [
          GoldCard(
            child: Column(
              ...
              children: [
                const Text('Calculate Your 1 Rep Max', style: TextStyle(fontFamily: 'Rajdhani',
                  fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.gold,
                )),
                const SizedBox(height: 4),
                const Text('Using Epley Formula: weight × (1 + reps/30)', style: TextStyle(fontFamily: 'Inter',
              ...
              return Container(
                ...
                child: Row(
                  children: [
                    ...
                    Text('${weight.toStringAsFixed(1)} kg', style: const TextStyle(fontFamily: 'Rajdhani',
